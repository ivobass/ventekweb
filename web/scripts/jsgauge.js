// jsgauge.js 
// by bkobos+githubp@extensa.pl
// https://github.com/bernii/gauge.js // http://bernii.github.io/gauge.js/
// MIT License
// bj added support for textPrefix and textSuffix
// bj added fix for divisionCount == 0
// bj adjusted gradient parameters.
// ------------------------------------------------------------------------------------------
...
(function() {
  ...
  TextRenderer = (function() {
    ...
    TextRenderer.prototype.render = function(gauge) {
	  // bj added support for textPrefix and textSuffix
      return this.el.innerHTML =  '<span class="' + gauge.options.textPrefixClass + '">' + gauge.options.textPrefix + '</span><span class="' + gauge.options.textNumberClass + '"> ' + formatNumber(gauge.displayedValue, this.fractionDigits) + ' </span><span class="' + gauge.options.textSuffixClass + '">' + gauge.options.textSuffix + '</span>';
    };
  ...
  Gauge = (function(superClass) {
    ...
    Gauge.prototype.renderTicks = function(ticksOptions, w, h, radius) {
      ...
      if (ticksOptions !== {}) {
        ...
        results = []; // bj moved up to before test below
		if (divisionCount==0){ return results;} //bj
      ...
      if (this.options.staticZones) {
        ...
        if (this.options.customFillStyle !== void 0) {
          ...
          if (this.options.gradientType === 0) {
			...
			fillStyle = this.ctx.createRadialGradient(w, h, 50, w, h, 100); // bj adjusted gradient parameters.
          } else {
